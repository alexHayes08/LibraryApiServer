import { GenericLockData, LockRecordData } from '../models/lock';
import { GenericLockableData, Lockable, LockableData } from '../models/lockable';
import { CrudPlusPattern } from './crud-plus-pattern';

export interface LockableService extends CrudPlusPattern<Lockable, GenericLockableData> {
    createMany(lockables: GenericLockableData[]): Promise<Lockable[]>;
